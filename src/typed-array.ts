...
const applyBitwise = (connective: BinaryConnective<number, number>, p: TypedArray, q: TypedArray) => {
...
const and: BinaryConnective<TypedArray, Uint8Array> = (p, q) => applyBitwise(bitwise.and, p, q);

const or: BinaryConnective<TypedArray, Uint8Array> = (p, q) => applyBitwise(bitwise.or, p, q);

const xor: BinaryConnective<TypedArray, Uint8Array> = (p, q) => applyBitwise(bitwise.xor, p, q);
